...
const Notifications: React.FC<NotificationsProps> = (props) => {
  ...
  return (
    <div className={style.notifications}>
      ...
      {isDropdownShow && (
        <Dropdown
          isShowCloseImg={notificationShow ? false : true}
          dropdownClose={() => handleDropdownShow()}
        >
                ...
                <div className={style.dropdown__list}>
                  {props.notifications.map((notification) => (
                    <div className={style.dropdown__item} key={notification.notificationId}>
                      <div className={style.dropdown__itemText}>
                        ...
                        <p
                          className={classNames(
                            notification.isRead
                              ? style.dropdown__itemText_read
                              : style.dropdown__itemText_noread,
                          )}
                        >
                      ...
                      <button
                        className={style.dropdown__itemButton}
                        onClick={() => setNotificationShow(notification)}
                      >
