        ...
        <> 
            ...
            {isShowMenu && (
                ...
                <nav className={style.header__nav}>
                    ...
                    <Link className={style.header__link} to='/'>Главная</Link>
                    <Link className={style.header__link} to={isAuth ? '/profile' : '/login'}>Профиль</Link>
                    <Link className={style.header__link} to={isAuth ? '/article-creator' : '/login'}>Написать статью</Link>
                </nav>
                </>
            )}
        </>
