...
export const setArticleSearch = () => async (dispatch: any) => {
    dispatch(setArticleSearchAC([
        {
            articleCreatedAt: '31.12.2025',
            articleDescription: 'Test descriptionTest descriptionTest descriptionTest descriptionTest descriptionTest descriptionTest descriptionTest description',
            articleId: 1,
